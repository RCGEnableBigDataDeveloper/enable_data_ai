...
public class EngineZKClient implements Watcher, Closeable {
    private static final Logger LOG = LoggerFactory.getLogger(EngineZKClient.class);
    ...
    public EngineZKClient(String hostPort) { 
    ...
    public static void main(String args[]) throws Exception { 
    	EngineZKClient c = new EngineZKClient(args[0]);
        c.startZK();

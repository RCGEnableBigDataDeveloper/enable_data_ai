/**
 * Encryption/Decryption class using a simple Data Encryption Standard (DES).
 */

package com.rcggs.datalake.security.encryption;
...
public class EncryptDecryptUtil {
	 ...
	 *            the {@link SecretKey}.
	 * @param password
	 *            the plan text password to encode.
	 ...
	 */
	public static String encrypt(SecretKey key, final String password)
	 ...
	 * @throws IOException
	 */
	public static String encrypt(final String filename, final String plainTextPassword) throws InvalidKeyException, NoSuchAlgorithmException, NoSuchPaddingException,
			UnsupportedEncodingException, IllegalBlockSizeException, BadPaddingException, IOException {
		return encrypt(readKeyFromFile(filename), plainTextPassword);
	}
	 ...
	 * @throws SAXException
	 */
	public static String decrypt(String secretKeyFileName, String encryptedPassword) throws IOException, InvalidKeyException, NoSuchAlgorithmException, NoSuchPaddingException,
	...
	public static String decrypt(InputStream is, String encryptedPassword) throws IOException, InvalidKeyException, NoSuchAlgorithmException, NoSuchPaddingException,
			IllegalBlockSizeException, BadPaddingException, ParserConfigurationException, SAXException {
	 ...
	 * @throws SAXException
	 */
	public static boolean isPasswordValid(String suppliedPassword, String secretKeyFileName, String passwordFileName) throws InvalidKeyException, NoSuchAlgorithmException,
			NoSuchPaddingException, IllegalBlockSizeException, BadPaddingException, IOException, ParserConfigurationException, SAXException {
		String decryptedPassword = decrypt(secretKeyFileName, passwordFileName);
	 ...
	 *            the {@link SecretKey}
	 * @param file
	 *            the file to write the secret key into.
	 * @throws IOException.
	 * @throws NoSuchAlgorithmException
	 */
	 ...
	 * 
	 * @param file
	 *            the file to read the secret key from.
	...
	public static void main(String[] args) throws InvalidKeyException, NoSuchAlgorithmException, NoSuchPaddingException, UnsupportedEncodingException, IllegalBlockSizeException,
		...
		String pwd = encrypt(System.getProperty("user.dir") + "/conf/datalake.key", "Cdi6954c");

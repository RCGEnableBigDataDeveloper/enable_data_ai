...
public class PluginController {
	...
	String url = "http://52.201.45.52:3005/v4"; 
	...
	public Response getDataElements() {
		...
		try {
			...
			while (w.hasNext()) {
				...
				parentLevel.setItemType("element");
				parentLevel.setItemType("element");
				...
				parentLevel1.setItemType("element");
				parentLevel1.setType("element");
				parentLevel1.setParent("");
				...
				parentLevel2.setItemType("object");
				parentLevel2.setType("object");
				parentLevel2.setParent("");
				config.setType("object");
				dataMap.put("config", config);
				parentLevel2.setData(dataMap);

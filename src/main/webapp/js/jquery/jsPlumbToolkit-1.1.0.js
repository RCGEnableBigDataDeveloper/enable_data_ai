...
;(function() {
    ...
    var DEFAULT_GET_CONNECTOR_STYLE = function(conn) {
        return {
            "stroke-width":2,
            stroke:"black",
            fill:"none"
...
// --------------------- calculate view box ----------------------------------------------
    ...
    _jtk.Renderers.AbstractRenderer.prototype.toSvg = function(params) {
        ...
        return this.getJsPlumb().toSvg({
            getConnectorStyle:function(connection) {
...
(function () {
    ...
    exports.Surface = function (params) {
        ...
        _super.toolkit.bind(_e.groupMemberAdded, function(info) {
            ...
            if (nodeEl) {
                // need to adjust the position of the new node
                // get it first
                // get the position of the group container
                // adjust node left/top so they are relative to group container's origin.
...
(function () {
    ...
    exports.Miniview = function (params) {
        ...
        var _nodeMoved = function (params) {
            ...
            JP.setAbsolutePosition(_super.nodeMap[(params.node || params.group).id], params.pos);
            _zoomToFit(true);

	...
	$(document)
			.ready(
					function() {
						...
						$.ajax({
							...
							success : function(data) {
								...
								$.each(data, function(key, item) {
									...
									addRow("<a target='_blank' href='https://portal.azure.com/#@rcgmail.onmicrosoft.com/resource/" + item.id + "'>"
											+ item.name + "</a>", item.id.substring(0, 75) + "..."	, item.location,
						...
						function addRow(str, id, loc,dt, row) {
							// console.log(str)
						...
						<table id="resource-table" class="display"
							...
							<thead>
								<tr>
									...
									<th style="font-size: 12px; font-weight: normal;">Path</th>
									<th style="font-size: 12px; font-weight: normal;">Location</th>
